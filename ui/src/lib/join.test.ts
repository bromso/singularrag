...
const r = { score: 0, file_rank: 0, seeds: [], referenced_by: [], pinned: false, fts_hit: false, query_ident_match: false, note_hit: false, body_hit: false, semantic: null, entities: [], themes: [] };
const items: Item[] = [
