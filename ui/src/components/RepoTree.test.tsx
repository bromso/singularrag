...
describe("RepoTree", () => {
  ...
  test("touched_files_render_first_with_a_retrieval", () => {
    const reasons = { score: 0.5, file_rank: 1, seeds: [], referenced_by: [{ path: "src/x.ts", count: 2 }], pinned: false, fts_hit: false, query_ident_match: false, note_hit: false, body_hit: false, semantic: null, entities: [], themes: [] };
    const items: Item[] = [
  ...
  test("a_live_refetch_keeps_the_user_expansion_but_a_new_retrieval_reseeds_it", async () => {
    ...
    const reasons = { score: 0.5, file_rank: 1, seeds: [], referenced_by: [], pinned: false, fts_hit: false, query_ident_match: false, note_hit: false, body_hit: false, semantic: null, entities: [], themes: [] };
